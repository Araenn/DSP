...
myReader = audioDeviceReader("SamplesPerFrame", N); %changer par dsp.AudioFileReader pour lecture fichier
Fs = myReader.SampleRate;
myWriter = audioDeviceWriter("SampleRate", Fs); %changer par dsp.AudioFileWriter pour ecriture fichier
